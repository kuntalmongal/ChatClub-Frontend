        ...
        <div className="py-4 m-5 w-50 shadow bg-white text-dark border rounded container">
            ...
            <div className="bg-light border rounded p-3 mb-4" style={{ height: "450px", overflowY: "scroll" }}>
               ...
               <div className="form-group d-flex">
                <input type="text" onKeyDown={handleEnter} onChange={handleChange} className="form-control bg-light" name="message" value={msg} placeholder="Type your message"></input>
                <button type="button" onClick={onSubmit} className="btn btn-warning mx-2 "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-send" viewBox="0 0 16 16">
